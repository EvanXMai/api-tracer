...
const listEl = (): HTMLElement => document.getElementById('list-pane') as HTMLElement
const detailElx = (): HTMLElement => document.getElementById('detail-pane') as HTMLElement
